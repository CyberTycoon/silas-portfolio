          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <AnimatedCard icon={FaCode}>
                ...
                <p>
                  Crafting seamless web applications with clean, modern code for an efficient user experience.
                </p>
              </AnimatedCard>
              ...
              {[
                {
                  ...
                  description:
                    "Real-time stock price updates with Google Sheets integration and notifications.",
                  icon: FaChartBar,
                },
                {
                  title: "Web Automation for Padel Club",
                  description:
                    "Automated court reservations using Selenium, with data logging to Google Sheets.",
                  icon: FaRobot,
                },
                {
                  title: "Image and Video Processing Suite",
                  description:
                    "Advanced solution for image retouching, video editing, and audio analysis.",
                  icon: FaCode,
                },
                {
                ...
                },
                {
                  ...
                  description:
                    "Responsive Next.js application with real-time weather data and modern UI.",
                  icon: FaRocket,
                },
                {
                  title: "Data Visualization Dashboard",
                  description:
                    "Interactive dashboard providing real-time insights and analytics for business data.",
                  icon: FaCog,
                },
              ].map((project, index) => (
                <motion.div
